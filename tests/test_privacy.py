...
class TestMaskUrlWithPath:
    ...
    def test_infura_v3_key(self) -> None:
        assert mask_url("https://mainnet.infura.io/v3/secretkey") == "https://mainnet.infura.io/••••••••"

    def test_alchemy_key(self) -> None:
        assert mask_url("https://eth-mainnet.alchemyapi.io/v2/myapikey") == "https://eth-mainnet.alchemyapi.io/••••••••"
...
class TestMaskUrlWithCredentials:
    ...
    def test_user_password_with_path(self) -> None:
        assert mask_url("https://user:password@server.example.com/apikey") == "https://••••••••@server.example.com/••••••••"
    ...
    def test_user_only_at_sign(self) -> None:
        ...
        assert mask_url("https://token@rpc.example.com/path") == "https://••••••••@rpc.example.com/••••••••"

    def test_http_credentials(self) -> None:
        assert mask_url("http://admin:pass@192.168.1.1:8545/rpc") == "http://••••••••@192.168.1.1:8545/••••••••"
